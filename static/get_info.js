...
async function getTrackIdsByArtist(artistName) {
  try {
    ...
    const searchUrl = `https://v1.nocodeapi.com/jmusicdn/spotify/oBFbFrulNWjqQdUy/search?q=${encodedArtistName}&type=track`;
...
async function getArtistInfo(artistName) {
  try {
          const accessToken =  '';
    const searchUrl = `https://v1.nocodeapi.com/jmusicdn/spotify/oBFbFrulNWjqQdUy/search?q=${encodeURIComponent(artistName)}&type=artist`;
