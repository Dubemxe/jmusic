...
async function searchSong() {
    try {
        ...
        const searchUrl = `https://v1.nocodeapi.com/jmusic4/spotify/kibKUujvhYKHJxPL/search?q=${encodeURIComponent(query)}&type=track`;
...
try {
        ...
        const trackInfoUrl = `https://v1.nocodeapi.com/jmusic4/spotify/kibKUujvhYKHJxPL/tracks?ids=${trackIdsStr}`;
