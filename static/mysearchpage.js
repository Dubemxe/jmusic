...
async function searchSong() {
    try {
        ...
        const searchUrl = `https://v1.nocodeapi.com/jmusic5/spotify/ivEUaoclsKKyrlqW/search?q=${encodeURIComponent(query)}&type=track`;
...
async function getTrackIdByArtist(artistName) {
  try {
    ...
    const searchUrl = `https://v1.nocodeapi.com/jmusic5/spotify/ivEUaoclsKKyrlqW/search?q=${encodedArtistName}&type=track`;
...
try {
        ...
        const trackInfoUrl = `https://v1.nocodeapi.com/jmusic5/spotify/ivEUaoclsKKyrlqW/tracks?ids=${trackIdsStr}`;
